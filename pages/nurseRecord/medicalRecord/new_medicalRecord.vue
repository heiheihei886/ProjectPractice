	...
	<view>
		...
		<view class="order">
			...
			<view class="row">
				...
				<view class="right">
					<input placeholder="Please enter the dispensing name" v-model="note_name" />
				</view>
			</view>
			<view class="row">
				<view class="left">
			...
			<view class="row">
				...
				<view class="right">
					<input placeholder="Please enter the dispensing content" v-model="note_content" />
				</view>
			</view>
			<view class="row">
				<view class="left">
	...
	export default {
		...
		methods: {
			...
			async toPay(){
				...
				uni.request({
					url:'http://52.77.228.143:8080/insertMedicalRecord',
