					...
					uni.request({
						...
						success:(res) =>{
							...
							if(res.data.code=="2"){
								...
								//初始化参数
								uni.setStorageSync('department_doc',res.data.data);
								uni.setStorageSync('docname',username);
								// let temp = uni.getStorageSync('userid')
								// console.log(temp)
								console.log("clear")
								setTimeout(function(){
									uni.navigateTo({
										url:'../tabBar/home/home_doc'
									})
								},1200)
							}else{
								uni.showToast({
					...
					uni.request({
						...
						success:(res) =>{
							...
							if(res.data.code=="2"){
								...
								//初始化参数
								uni.setStorageSync('department_nurse',res.data.data);
								uni.setStorageSync('nurseName',username);
								// let temp = uni.getStorageSync('userid')
								// console.log(temp)
								console.log("clear")
								setTimeout(function(){
