...
export default {
	data() {
		return {
			...
			// 分类菜单
			categoryList: [
				{ id: 1, name: 'Create Medical Record', img: '/static/img/category/1.png' },
				{ id: 2, name: 'Medical Records', img: '/static/img/category/2.png' },
				{ id: 3, name: 'Information Query', img: '/static/img/category/3.png' },
