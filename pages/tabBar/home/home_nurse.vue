	...
	methods: {
		...
		toCategory(e) {
			...
			switch(e.id){
				case 1:
					uni.navigateTo({
						url:'../../nurseRecord/nursingRecord/nursingRecordUser'
					});
					break;
				case 2:
					uni.navigateTo({
						url:'../../nurseRecord/medicalRecord/medicalRecordUser'
					});
					break;
				case 3:
					uni.navigateTo({
						url:'../../nurseRecord/accessRecord/accessRecordUser'
					});
				case 4:
					uni.navigateTo({
						url:'../../nurseRecord/nursingRecord/new_nursingRecord'
					})
				case 5:
					uni.navigateTo({
						url:'../../nurseRecord/medicalRecord/new_medicalRecord'
					})
				case 6:
					uni.navigateTo({
						url:'../../nurseRecord/accessRecord/new_accessRecord'
					})
				case 7:
					uni.navigateTo({
						url:'../../login/login'
