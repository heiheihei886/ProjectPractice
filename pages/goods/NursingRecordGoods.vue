...
<template>
	<view>
		...
		<!-- <view class="footer">
			...
			<view class="btn">
				<view class="buy" @tap="buy">前往诊断</view>
			</view>
		...
		<view class="info-box goods-info">
			<view class="price">Nursing Record</view>
			<view class="title">
				{{goodsData.name}}
			</view>
		</view>
		...
		<view class="info-box comments" id="comments">
			<view class="row">
				<view class="text">Nursing details</view>
...
export default {
	data() {
		return {
			...
			goodsData:{
				...
				// 	username:'啦啦啦',
				// 	content:'很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好很好'
				// }
			},
			userData:{},
			...
			goodsId:0,
			//商品描述html
			descriptionStr:'<div style="text-align:center;"><img width="100%" src="../../static/img/1.jpg"/><img width="100%" src="../../static/img/1.jpg"/></div>'
		};
	},
	// onLoad(option) {
	// 	// #ifdef MP
	...
	// },
	onLoad(){
		let gd = uni.getStorageSync('goodsId')
		this.goodsId = gd
	...
	methods: {
		...
		getNursingRecord(){
			return new Promise((resolve, reject) => {	
				uni.request({
					url:'http://52.77.228.143:8080/getNursingRecordById',
					data:{
						id:this.goodsId
					},
					success: (res) => {
		...
		toConfirmation(){
			let tmpList=[];
			let goods = {id:this.goodsData.id,img:'../../static/img/goods/p1.jpg',name:this.goodsData.name,date:this.goodsData.date,priority:this.goodsData.priority};
			tmpList.push(goods);
			uni.setStorage({
				key:'buylist',
				data:tmpList,
		...
		back() {
			uni.navigateTo({
				url:'../nurseRecord/nursingRecord/nursingRecord'
			});
		},
		//服务弹窗
		showService() {
